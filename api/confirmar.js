...
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
  <tr>
    <td width="50%" style="padding-right:5px;">
      <a href="${base}/boleto?t=${token}&dl=1" style="display:block;background:linear-gradient(135deg,#7C3AED,#00CFFF);color:#ffffff;text-align:center;padding:14px 10px;border-radius:12px;font-size:14px;font-weight:700;text-decoration:none;font-family:Arial,sans-serif;letter-spacing:0.02em;">⬇&nbsp; Guardar PDF</a>
    </td>
